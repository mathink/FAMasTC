...
# coq_makefile FAM.v MonadDef.v ApplicativeDef.v FunctorDef.v TypeModifier.v RelationClasses.v Util.v -R . FAM 
#
...
install:
	...
	(for i in $(VOFILES); do \
	 install -d `dirname $(COQLIB)/user-contrib/FAM/$$i`; \
	 install $$i $(COQLIB)/user-contrib/FAM/$$i; \
	 done)
